...
// Categories list
const categories = [
    { id: 1, title: "Water Bottle", img: cateimg1 },
    { id: 2, title: "Lunch Box", img: cateimg1 },
    { id: 3, title: "Notebook", img: cateimg1 },
    { id: 4, title: "Pen", img: cateimg1 },
    { id: 5, title: "Bag", img: cateimg1 },
];
...
export default function L1() {
    ...
    const getVisibleItems = () => {
        return Array(visibleCount)
            .fill(0)
            .map((_, i) => categories[(startIndex + i) % categories.length]);
    };
        ...
        <div className="full-section border-[#5399DA] border-solid border-[2px]">
            ...
            <div className="header flex flex-row justify-between p-[15px] items-center">
                ...
                <div className="logo-content flex flex-row items-center gap-[25px]">
                    ...
                    <div className="shopping-icons flex flex-row gap-[10px]">
                        ...
                        <Link href={isLoggedIn ? "/profile" : "/default-channel/login"}>
            ...
            <div className="header-search px-[15px] py-[5px]">
                <div className="flex flex-row items-center h-9 w-full rounded-full border-2 border-dashed border-pink-800 bg-blue-100 px-4">
                    ...
                    <Input
                        className="h-full flex-1 border-none bg-transparent text-sm placeholder-gray-500 focus:ring-0"
                        placeholder="Search..."
                    />
                </div>
            </div>
            ...
            <div className="categories-sec">
                <h3 className="text-[20px] text-[#B71557] capitalize pt-[20px] mb-[15px] text-center font-[600]">
                    Categories
                </h3>

                <div
                    className="categories-content-grid flex flex-row max-w-[375px] w-full justify-center gap-[25px] transition-all duration-500 ease-in-out"
                    onMouseEnter={() => setIsPaused(true)}
                    onMouseLeave={() => setIsPaused(false)}
                >
                    <div className="categories-content-arrow cursor-pointer" onClick={slideLeft}>
                        <Image src={leftarrow} alt="Left" />
                    </div>

                    <div className="categories-content-grid flex flex-row max-w-[375px] w-full justify-center gap-[25px] transition-all duration-500 ease-in-out">
                        {getVisibleItems().map((item) => (
                            <div key={item.id} className="categories-content text-center">
                                <Image src={item.img} alt={item.title} />
                                <h3 className="text-[11px] text-[#22609B] capitalize mt-[8px] font-[500]">
                                    {item.title}
                                </h3>
                            </div>
                        ))}
                    ...
                    <div className="categories-content-arrow cursor-pointer" onClick={slideRight}>
