...
export const ServicesSection = (): JSX.Element => {
	...
	return (
		<section
			...
			className="relative lg:h-12 lg:h-24 w-full overflow-hidden border-2 border-dashed border-black"
		>
			<div className="flex h-full w-full">
				...
				<div className="animate-marquee flex whitespace-nowrap">
					{[1, 2, 3].map((item) => (
						...
						>
							<p className="font-baloo md:text-3xl lg:text-5xl font-extrabold text-[#961147]">{bannerText}</p>
						</div>
					))}
				</div>
