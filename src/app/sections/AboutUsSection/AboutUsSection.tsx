...
export const AboutUsSection = (): JSX.Element => {
	return (
		<section className="relative z-40 ml-6 h-[518px] w-full" style={{ zoom: "110%" }}>
			<div className="relative w-full">
				{/* Background fill for empty bottom space */}
				<div className="absolute inset-0 z-0 -ml-6 -mt-20 w-full bg-[#d9e9f7]" />
				<div
					className="absolute -left-20 -top-[106px] h-[693px] w-[1608px] rounded-[500px] bg-[url(/rectangle-12-3.svg)] bg-[100%_100%]"
					style={{ left: "50%", transform: "translateX(-50%) translateX(-80px)" }}
				>
