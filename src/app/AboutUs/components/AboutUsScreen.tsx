...
export const AboutUsScreen = (): JSX.Element => {
	const featureCards = [
		{
			icon: <Image src="/hugeicons-safe.svg" alt="Support" width={34} height={36} />,
			iconBg: "bg-[#f7bfd5]",
			title: "100% Safe Toys",
		...
		{
			icon: <Image src="/headphones 1.png" alt="Support" width={34} height={36} />,
			iconBg: "bg-[#f7bfd5]",
		...
		{
			icon: <Image src="/stars 1.png" alt="Support" width={34} height={36} />,
			iconBg: "bg-[#f7bfd5]",
		...
		{
			icon: <Image src="/Group (2).png" alt="Support" width={34} height={36} />,
			iconBg: "bg-[#f7bfd5]",
		...
		{
			icon: <Image src="/delivery-truck 1.png" alt="Support" width={34} height={36} />,
			iconBg: "bg-[#f7bfd5]",
			title: "Free Shipping",
		...
		{
			icon: <Image src="/package.png" alt="Organic" width={33} height={36} />,
			iconBg: "bg-[#f7bfd5]",
	...
	return (
		<div className="w-full bg-white">
			...
			<section className="flex w-full flex-col gap-20 px-4 py-16 md:flex-row md:gap-60">
