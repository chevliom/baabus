...
export const AboutUsByAnima = (): JSX.Element => {
	return (
		<section className="w-full px-4 md:py-16 py-8 md:px-8 lg:px-10">
			<div className="container mx-auto flex flex-col items-center gap-8 lg:flex-row lg:gap-16">
				{/* Text Content */}
				<div className="w-full md:space-y-8 lg:w-1/2">
					<h2 className="font-['Poppins',Helvetica] text-[24px] md:text-[40px] font-semibold text-black">
						Parent-Friendly Shopping
					</h2>

					<p className="font-body-large-body-large-400 text-gray-scalegray-600 mt-1 md:8 text-[15px] md:text-[17px]">
